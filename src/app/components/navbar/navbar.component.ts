...
export class NavbarComponent implements OnInit {
    ...
    public user : any;
    public menu : any = [];
    constructor(public dialog : MatDialog, public authService : AuthService, public us : UsersService, public router : Router, public ms : MenuService, private spinnerService : Ng4LoadingSpinnerService) {}
